...
class SppMLForecasterCachedModel(SppMLForecaster):
    ...
    #     return model
    #
    # def __getNewRegressor__(self, train_features: ps.DataFrame, train_labels: ps.DataFrame):
    #     return None
    #
    # def __getRetrainRegressor__(self, model, modelLastTrainingDate, train_features: ps.DataFrame, train_labels: ps.DataFrame
    #                             , train_features_next: ps.DataFrame, train_labels_next: ps.DataFrame):
    #     return None
